...
class MainLayout(FloatLayout):
    def __init__(self, **kwargs):
        ...
        with self.canvas.before:
            Color(1, 1, 1, 1)  
            self.bg_rect = Rectangle(source='bg_scooby.jpg', size=self.size, pos=self.pos)
    ...
    def update_timer(self, dt):
        ...
        if self.time_left <= 0:
            ...
            self.word_label.text = "RUH-ROH! TIME'S UP!" 
            self.underscore_label.text = "" # ซ่อนเส้นใต้เมื่อเกมจบ
